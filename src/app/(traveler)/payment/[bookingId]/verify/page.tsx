      ...
      <div className="space-y-5">
        <Card>
          <CardContent className="py-10 text-center">
            <div className="w-16 h-16 rounded-full bg-error-bg dark:bg-error-bg flex items-center justify-center mx-auto mb-4">
              <svg className="w-8 h-8 text-error" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
              </svg>
            </div>
            <h1 className="font-display text-xl font-bold text-foreground mb-2">Payment Failed</h1>
            <p className="text-sm text-foreground/50 font-body mb-6">{result.error}</p>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link href="/history">
                <button className="w-full px-5 py-3 bg-muted-bg dark:bg-dark-surface dark:border dark:border-white/5 text-foreground rounded-xl font-body text-sm font-medium hover:bg-mist dark:hover:bg-white/5 transition-colors cursor-pointer">
                  Back to Bookings
                </button>
              </Link>
            </div>
    ...
    <div className="space-y-5">
      <Card className="shadow-lg border-0">
        <CardContent className="py-10 text-center">
          ...
          <p className="text-sm text-foreground/50 font-body mb-1">
