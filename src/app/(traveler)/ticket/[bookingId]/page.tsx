      ...
      <div className="space-y-4">
        ...
        <Card>
          <CardContent className="py-10 text-center">
            ...
            <p className="text-sm text-foreground/50 font-body">This booking may not have a ticket yet.</p>
          </CardContent>
        </Card>
      </div>
    );
        ...
        <Card id="ticket-card" className="shadow-xl border-0 overflow-hidden bg-white dark:bg-dark-surface dark:text-white">
          ...
          <CardContent className="pt-6 pb-6">
            ...
            <div className="flex items-start justify-between mb-5">
              <div>
                <p className="font-label text-foreground/40 mb-1">E-Ticket</p>
            ...
            {/* Dotted divider */}
            <div className="border-t-2 border-dashed border-mist dark:border-white/5 my-5 -mx-6" />

            {/* Ticket code */}
            <div className="text-center mb-5">
              <p className="text-xs text-foreground/40 font-body mb-2">Show this code to the driver</p>
            ...
            <div className="grid grid-cols-2 gap-3 text-sm font-body">
              <div className="p-3 rounded-xl bg-muted-bg dark:bg-white/5">
                <p className="text-xs text-foreground/40 mb-1">Seats</p>
                <p className="font-semibold text-foreground">{booking.seats_requested}</p>
              </div>
              <div className="p-3 rounded-xl bg-muted-bg dark:bg-white/5">
                <p className="text-xs text-foreground/40 mb-1">Fare Paid</p>
                <p className="font-semibold text-foreground">
                  ₦{(Number(route.fare) * booking.seats_requested).toLocaleString()}
                </p>
              </div>
              <div className="p-3 rounded-xl bg-muted-bg dark:bg-white/5">
                <p className="text-xs text-foreground/40 mb-1">Issued</p>
              ...
              <div className="p-3 rounded-xl bg-muted-bg dark:bg-white/5">
                <p className="text-xs text-foreground/40 mb-1">Booking ID</p>
            ...
            {route.bus_number && (
              <div className="mt-3 p-3 rounded-xl bg-muted-bg dark:bg-white/5 text-sm font-body">
                <p className="text-xs text-foreground/40 mb-1">Bus Number</p>
